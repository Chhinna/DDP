...
class CIFAR100(Dataset):
    ...
    def __init__(self, args, partition='train', pretrain=True, is_sample=False, k=4096,
            ...
            load_data_from_pickle_file(self, partition)
    
            # pre-process for contrastive sampling
            self.k = k
            self.is_sample = is_sample
            preprocess_for_contrastive_sampling(self)
    ...
    def load_data_from_pickle_file(self, partition):
    ...
    def preprocess_for_contrastive_sampling(self):
        if self.is_sample:
...
class MetaCIFAR100(CIFAR100):
    ...
    def __init__(self, args, partition='train', train_transform=None, test_transform=None, fix_seed=True):
            ...
            set_train_transformations(train_transform, self)
    
            set_test_transformations(test_transform, self)
    
            populate_data_dict(self)
    
    def set_train_transformations(train_transform, self):
    ...
    def set_test_transformations(test_transform, self):
    ...
    def __getitem__(self, item):
            ...
            """
            query_xs, query_ys, support_xs, support_ys = sample_support_query_sets(self, item)
            support_xs, query_xs, support_ys, query_ys = reshape_and_split_batches(query_xs, query_ys, support_xs, self, support_ys)
    
            support_xs, query_xs = apply_transformations(self, support_xs, query_xs)
    
            return support_xs, support_ys, query_xs, query_ys
    
    def sample_support_query_sets(self, item):
        if self.fix_seed:
            np.random.seed(item)
    ...
    def reshape_and_split_batches(query_xs, query_ys, support_xs, self, support_ys):
