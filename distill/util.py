...
class Normalize(nn.Module):
    ...
    def forward(self, x):
        ...
        Processing Logic:
            ...
            - Sum along dimension 1 and keep the dimension to get the norm
            - Take the power of 1/self.power to the norm to invert the operation
            - Divide x by the norm to normalize it along dimension 1."""
