...
class Normalize(nn.Module):
    ...
    def forward(self, x):
        ...
        Args:
            ...
            self.power: Power to raise values to before normalization (default: 2).
        Returns: 
            x: Normalized tensor with the same shape as input.
        - Raise each element of input x to the power of self.power
        - Sum over the specified dimension to get norm
        - Take the power of 1/self.power of the norm 
        - Divide each element of x by the calculated norm"""
