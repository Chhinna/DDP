...
class BCEWithLogitsLoss(nn.Module):
    def __init__(self, weight=None, size_average=None, reduce=None, reduction='mean', pos_weight=None, num_classes=64):
        ...
        - Applies weights to loss of each sample if provided
        - Averages loss over samples or entire batch based on arguments
    ...
    def forward(self, input, target):
        ...
        Returns:
            loss: Loss between input predictions and target
        Computes one-hot encoding of target
            Applies softmax to input to get predictions
            Computes cross-entropy loss between predictions and one-hot target"""
...
def create_and_save_embeds(opt, vocab):
    ...
    Processing Logic:
        ...
        - Gets list of words from vocabulary
...
def create_and_save_descriptions(opt, vocab):
    ...
    Processing Logic:
        ...
        - Save dictionary of vocab words to embeddings in pickle file
    """
